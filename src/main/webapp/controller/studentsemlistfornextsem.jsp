...
Student student = new Student();
FetchStudentForSemUpdate studentforsem = new FetchStudentForSemUpdate();
List<Student> studentlist = studentforsem.getStudentDetailsForSemUpdate(sess, dept, sem);
	...
	<table class="table table-bordered" id="myTable">
			...
			<tbody>
				...
				<tr>
					...
					<div class="form-group">
						<input type="text" name="nextsem_<%=student.getRollno()%>" id="nextsem" class="form-control" placeholder="Next Semester" />
					</div>					
		...
		<div class="row">
			<div class="col-md-3 offset-md-3" id="v">
				<a href="/Attenence_management_system/searchstudentsemupdate.jsp" class="btn btn-primary btn-lg ">
					Back</a>
			</div>
