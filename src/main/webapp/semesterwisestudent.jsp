			...
			<div class="col-md-6">
				<div class="card">
					<div class="card-header">
						<h2 class="text-center">Semester Wise Report</h2>
					</div>
					<div class="card-body">
						<form action="controller/semester_report_controller.jsp">
							...
							<%-- 	<div class="form-group">
								...
								<div class="form-group text-center">
									...
									<a href="admindashboard.jsp" class="btn btn-primary btn-lg ">
										Back</a>
								</div>
