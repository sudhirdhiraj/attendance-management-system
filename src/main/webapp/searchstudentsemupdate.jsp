...
<body>
	...
	<div class="container">
		<div class="card mx-auto mt-5" style="max-width: 500px;">
			...
			<div class="card-body">
				<form action="controller/studentsemlistfornextsem.jsp">
					...
					<div class="form-group">
						<label for="dept">Select Department</label> <select id="dept"
							class="form-control" name="dept" required>
					...
					<div class="form-group">
						<label for="sem">Current Semester</label><input type="text" name="sem"
							id="sem" class="form-control" placeholder="Semester"
							required />
					</div>
					...
					<div class="row">
						<div class="col-md-3 offset-md-3">
							<a href="admindashboard.jsp"
								class="btn btn-primary btn-lg btn-block">Back</a>
						</div>
